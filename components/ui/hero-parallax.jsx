...
export const HeroParallax = ({ products }) => {
  ...
  return (
    <div
      ref={ref}
      className="h-[320vh] md:h-[300vh] py-0 md:py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] -top-14"
    >
      <Header />
      <motion.div
        style={{
